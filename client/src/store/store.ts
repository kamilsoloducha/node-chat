...
import { loadHistoryEpic, selectChatEpic, getPreviousMessagesEpic } from 'store/chat/epics';
import chatReducer from 'store/chat/reducer';

export const rootEpic = combineEpics(loadHistoryEpic as any, selectChatEpic as any, getPreviousMessagesEpic as any);
